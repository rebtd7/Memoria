...
public static class ff9
{
	static ff9()
	{
		UInt32[] array = new UInt32[2];
		array[0] = 602734592u;
		ff9.w_movementWaterStatus = array;
		...
		ff9.w_effectMillPos = new Vector3(ff9.S(280140), ff9.S(7784), ff9.S(-206465));
		ff9.w_effectMillRot = Vector3.zero;
		ff9.w_effectTwisPos = new Vector3(ff9.S(229007), ff9.S(0), ff9.S(-198927));
		ff9.w_effectLastPos = new Vector3(ff9.S(196602), ff9.S(10882), ff9.S(-82002));
		ff9.w_effectLastPos1 = new Vector3(ff9.S(196602), ff9.S(12000), ff9.S(-82002));
		...
		ff9.kFF9FogCharHI = ff9.S(-5279);
		ff9.kFF9FogCharLOW = ff9.S(-3103);
		ff9.p1 = 4;
		ff9.p2 = 8;
		ff9.p3 = 32;
		ff9.WH1 = ff9.S(2048);
		...
		ff9.s_moveCHRControl[] array4 = new ff9.s_moveCHRControl[12];
		array4[0] = new ff9.s_moveCHRControl
		{
			type = 0,
			flg_gake = 0,
			speed_move = 112,
		...
		array4[1] = new ff9.s_moveCHRControl
		{
			type = 0,
			flg_gake = 0,
			speed_move = 200,
		...
		array4[2] = new ff9.s_moveCHRControl
		{
			type = 0,
			flg_gake = 1,
			speed_move = 200,
		...
		array4[3] = new ff9.s_moveCHRControl
		{
			type = 0,
			flg_gake = 1,
			speed_move = 200,
		...
		array4[4] = new ff9.s_moveCHRControl
		{
			type = 0,
			flg_gake = 1,
			speed_move = 200,
		...
		array4[5] = new ff9.s_moveCHRControl
		{
			type = 0,
			flg_gake = 1,
			speed_move = 200,
		...
		array4[6] = new ff9.s_moveCHRControl
		{
			type = 1,
			flg_gake = 0,
			speed_move = 300,
		...
		Int32 num = 7;
		ff9.s_moveCHRControl s_moveCHRControl = new ff9.s_moveCHRControl();
		s_moveCHRControl.type = 2;
		s_moveCHRControl.flg_gake = 0;
		s_moveCHRControl.speed_move = 240;
		s_moveCHRControl.speed_rotation = 36;
		s_moveCHRControl.speed_updown = 0;
		s_moveCHRControl.speed_roll = 0;
		s_moveCHRControl.speed_rollback = 0;
		s_moveCHRControl.flg_fly = false;
		s_moveCHRControl.flg_upcam = true;
		s_moveCHRControl.fetchdist = 3;
		s_moveCHRControl.music = 0;
		s_moveCHRControl.se = 24;
		s_moveCHRControl.encount = false;
		s_moveCHRControl.radius = 560;
		s_moveCHRControl.camrot = false;
		s_moveCHRControl.pad2 = 0;
		ff9.s_moveCHRControl s_moveCHRControl2 = s_moveCHRControl;
		UInt32[] array5 = new UInt32[2];
		array5[0] = 39845888u;
		s_moveCHRControl2.limit = array5;
		array4[num] = s_moveCHRControl;
		array4[8] = new ff9.s_moveCHRControl
		{
			type = 1,
			flg_gake = 0,
			speed_move = 500,
		...
		array4[9] = new ff9.s_moveCHRControl
		{
			type = 1,
			flg_gake = 0,
			speed_move = 500,
		...
		array4[10] = new ff9.s_moveCHRControl
		{
			type = 3,
			flg_gake = 0,
			speed_move = 140,
		...
		array4[11] = new ff9.s_moveCHRControl
		{
			type = 0,
			flg_gake = 0,
			speed_move = 0,
		...
		ff9.w_moveCHRStatus = new ff9.s_moveCHRStatus[]
		{
	...
	{
		Int32 num = 32768 | (z << 8 & 16128) | (x << 2 & 252) | (id & 3);
		if (!FF9StateSystem.World.IsBeeScene)
		{
	...
	{
		return 32768 | (z << 8 & 16128) | (x << 2 & 252) | (id & 3);
	}
	...
	public static Boolean IsBeeScene
	{
		get
		{
			return FF9StateSystem.World.IsBeeScene;
		}
	}
	...
	public static FF9StateGlobal FF9Global
	{
		get
		{
			return FF9StateSystem.Common.FF9;
		}
	}

	public static FF9StateSystem FF9Sys
	{
		get
		{
			return PersistenSingleton<FF9StateSystem>.Instance;
		}
	}

	public static WMWatcher watcher
	{
		get
		{
			return Singleton<WMWatcher>.Instance;
		}
	}
	...
	private static WMRenderTextureBank renderTextureBank
	{
		get
		{
			return Singleton<WMRenderTextureBank>.Instance;
		}
	}

	private static WMTweaker tweaker
	{
		get
		{
			return Singleton<WMTweaker>.Instance;
		}
	}

	public static Single S(Int32 fixedPoint)
	{
		return fixedPoint * 0.00390625f;
	}

	public static Int32 UnityUnit(Single f)
	{
		return (Int32)(f * 256f);
	}
	...
	public static void w_cameraSystemConstructor()
	{
		...
		ff9.setVector(ref ff9.w_cameraUpvector, 0f, ff9.S(20000), 0f);
	...
	public static void w_cameraUpdate()
	{
		...
		if (ff9.w_moveCHRControlPtr.type_cam == 1)
		{
			...
			{
				num = 8f;
				ff9.world.MainCamera.fieldOfView = 350f / num;
			}
		}
	...
	{
		Single num = ff9.S(4500);
		Single num2 = ff9.S(1500);
		Single num3 = ff9.S(16);
		Single y = 0f;
		if (!ff9.GetEventAim())
		{
			Single num4 = ff9.w_moveActorPtr.pos[0];
			Single num5 = ff9.w_moveActorPtr.pos[1] + ff9.w_cameraAimOffset;
			Single num6 = ff9.w_moveActorPtr.pos[2];
			...
			if (ff9.w_cameraInter)
			{
				...
				{
					if (ff9.abs(ff9.w_cameraWorldAim.x - num4) < num3)
					{
						ff9.w_cameraSmoothX = false;
					}
					else
				...
				{
					if (ff9.abs(ff9.w_cameraWorldAim.y - num5) < num3)
					{
						ff9.w_cameraSmoothY = false;
					}
					else
					{
						Vector3 vector2 = ff9.w_cameraWorldAim;
						vector2.y += (ff9.GetControlChar().pos[1] - ff9.w_cameraWorldAim.y + ff9.w_cameraAimOffset) / 8f;
						ff9.w_cameraWorldAim = vector2;
					}
				}
				if (ff9.w_cameraSmoothZ)
				{
					if (ff9.abs(ff9.w_cameraWorldAim.z - num6) < num3)
					{
						ff9.w_cameraSmoothZ = false;
					}
					else
					{
						Vector3 vector3 = ff9.w_cameraWorldAim;
						ff9.w_cameraWorldAim.z = ff9.w_cameraWorldAim.z + (ff9.GetControlChar().pos[2] - ff9.w_cameraWorldAim.z) / 8f;
						ff9.w_cameraWorldAim = vector3;
					}
				}
				if (!ff9.w_cameraSmoothX)
				{
				...
				if (!ff9.w_cameraSmoothY)
				{
					ff9.w_cameraWorldAim.y = num5;
				}
				if (!ff9.w_cameraSmoothZ)
				{
					ff9.w_cameraWorldAim.z = num6;
				}
			}
			else
			{
				Single num7 = num5 - ff9.w_cameraWorldAim.y;
				Single num8 = 0f;
				Int32 num9 = 0;
				if (num7 > ff9.S(128))
				{
				...
				ff9.nsp = ff9.abs(num7) / 32f;
				if (ff9.nsp < ff9.S(32))
				{
					ff9.nsp = ff9.S(32);
				}
				if (ff9.nsp > ff9.S(256))
				{
					ff9.nsp = ff9.S(256);
				}
				if (num9 != 0)
				...
				ff9.w_cameraWorldAim.x = num4;
				ff9.w_cameraWorldAim.z = num6;
				if (ff9.abs(num8) > ff9.S(4) && !ff9.w_cameraFixModeY)
				{
		...
		if (!ff9.GetEventEye())
		{
			...
			vector4.x = num18 + ff9.w_cameraDirVector.x / 4f;
			vector4.y = num19;
			vector4.z = num20 + ff9.w_cameraDirVector.z / 4f;
			...
			{
				Int32 num22;
				ff9.w_cellHit(ref vector4, ref idall, out num22, ff9.w_cameraHit[0], out num12);
			}
			...
			{
				num11 = 1f;
				if (ff9.m_GetIDTopograph(idall) == 49)
				{
					num11 = 4f;
				}
				if (ff9.w_movePadDOWN)
				{
					num11 = 4f;
				}
				if (ff9.w_movePadLR)
		...
		Single num28 = ff9.w_cameraWorldEye.x + ff9.S(196471);
		Single num29 = ff9.w_cameraWorldEye.z + ff9.S(81969);
		Single num30 = ff9.S(14000);
		if (ff9.abs(num28) < num30 && ff9.abs(num29) < num30)
		{
			Single num31 = num30 * num30 - num28 * num28 - num29 * num29;
			Single num32 = ff9.SquareRoot0(num31) - ff9.S(2200);
		...
		if (ff9.w_cameraWorldEye.y > ff9.S(18383))
		{
			ff9.w_cameraWorldEye.y = ff9.S(18383);
		}
	}
	...
	public static void w_cameraChangeUpdate()
	{
		...
		sworldStateCamera.upperCounter = (Int16)(sworldStateCamera.upperCounter + (Int16)ff9.w_cameraSysDataCamera.upperCounterSpeed);
		...
		{
			ff9.w_cameraChangeCounter = (Int16)(ff9.w_cameraChangeCounter + ff9.w_cameraChangeCounterSpeed);
	...
	public static void w_effectSystemConstructor()
	{
		...
		ff9.setVector(ref ff9.w_effectModelPos[0], ff9.S(280140), ff9.S(7784), ff9.S(-206465));
		ff9.setVector(ref ff9.w_effectModelPos[1], ff9.S(229467), ff9.S(-500), ff9.S(-198727));
		ff9.setVector(ref ff9.w_effectModelPos[6], ff9.S(196602), ff9.S(10882), ff9.S(-82002));
	...
	public static void w_cellService()
	{
		...
		ff9.w_effectServiceSP(4);
		ff9.w_effectUpdateSP(4);
		ff9.w_effectServiceSP(5);
		ff9.w_effectUpdateSP(5);
		ff9.w_effectServiceSP(6);
	...
	public static WMBeeOnWillRenderObject BeeOnWMBeeOnWillRenderObject
	{
		get
		{
			return Singleton<WMBeeOnWillRenderObject>.Instance;
		}
	}

	public static void w_effectService()
	{
		...
		for (Int32 i = 0; i < spsList.Count; i++)
		{
			...
			if (worldSPS.spsBin != null)
			{
				if (worldSPS.no != -1)
				{
					...
					case 0:
					case 1:
						position.y += ff9.S(150);
						ff9.w_frameShadowOTOffset = 40;
						worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame, worldSPS.type, -1, 0, 0);
						break;
					case 2:
						ff9.w_frameShadowOTOffset = 0;
						worldSPS.size = worldSPS.frame * 400 + 6000;
						worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame / 4 % 26, worldSPS.type, -1, 0, 2);
						break;
					case 3:
						ff9.w_frameShadowOTOffset = 0;
						worldSPS.size = worldSPS.frame * 400 + 6000;
						worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame / 2 % 23, worldSPS.type, -1, 0, 2);
						break;
					case 4:
					case 5:
					case 6:
					...
					case 15:
						vector = new Vector3(ff9.PsxRot(1024), 0f, 0f);
						ff9.w_frameShadowOTOffset = 20;
						worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame, worldSPS.type, 12, 0, 0);
						break;
					case 16:
						vector = new Vector3(ff9.PsxRot(1024), 0f, 0f);
						ff9.w_frameShadowOTOffset = 20;
						...
						{
							vector.y = worldSPS.frame * 128;
							worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame, 1, -1, 0, 0);
						}
						else
						{
							vector.y = worldSPS.frame * 200;
							worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame, 2, -1, 0, 0);
						}
						ff9.effect16FrameCounter++;
						break;
					case 20:
						position.z += ff9.S(-250);
						ff9.w_frameShadowOTOffset = 40;
						worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame, worldSPS.type, -1, 0, 0);
						break;
					case 22:
						vector = new Vector3(ff9.PsxRot(1024), 0f, 0f);
						ff9.w_frameShadowOTOffset = 20;
						worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame, worldSPS.type, 236, 0, 0);
						break;
					case 25:
					case 26:
					{
					...
					if (vector == Vector3.zero)
					{
						...
						if (worldSPS.no == 25)
						{
							Transform transform = ff9.world.kWorldPackEffectBlack;
							Vector3 position2 = transform.position + transform.TransformDirection(new Vector3(0f, 0f, 0.5f));
							worldSPS.transform.position = position2;
						}
						worldSPS.transform.LookAt(worldSPS.transform.position + rotation * Vector3.back, rotation * Vector3.up);
					}
					else
					{
						worldSPS.transform.rotation = Quaternion.Euler(worldSPS.rot);
					}
					Single num3 = ff9.PsxScale(worldSPS.size);
					worldSPS.transform.localScale = new Vector3(num3, num3, num3) * 0.00390625f;
					goto IL_64A;
					IL_51C:
					ff9.w_frameShadowOTOffset = 40;
					worldSPS.S_WoSpsPut(worldSPS.spsBin, pos, vector, worldSPS.size, worldSPS.frame, worldSPS.type, -1, 0, 0);
	...
	public static void w_effectServiceSP(Byte no)
	{
		switch (no)
		{
		case 4:
			...
			break;
		case 6:
			if (ff9.w_frameDisc == 4 || ff9.tweaker.HaskEffectBlockEva)
			{
	...
	public static void w_effectUpdateSP(Byte no)
	{
		Boolean flag = false;
		switch (no)
		{
		...
		{
			no = (Byte)(no - 1);
			if (no >= ff9.w_effectDataList.Length)
			{
	...
	public static void w_effectUpdate()
	{
		Boolean flag = false;
		...
		WorldSPSSystem worldSPSSystem = ff9.world.WorldSPSSystem;
		List<WorldSPS> spsList = worldSPSSystem.SpsList;
		for (Int32 i = 0; i < spsList.Count; i++)
		{
			WorldSPS worldSPS = spsList[i];
			if (worldSPS.spsBin != null)
				...
				if (worldSPS.no != -1)
				{
					...
					if (no != 2)
					{
						if (no != 3)
						{
							...
							{
								worldSPS.pos[0] = ff9.rsin(worldSPS.frame * 64 + worldSPS.prm0) / 2 + ff9.w_effectTwisPos.x;
						...
						if (no != 3)
						{
							if (no != 16 && no != 17)
							{
								if (no != 25)
								{
									if (no != 32)
									{
										if (worldSPS12.frame == worldSPSSystem.GetSpsFrameCount(worldSPS12.spsBin))
										{
											worldSPSSystem.w_effectRelease(index12);
										}
									}
		...
		if (ff9.w_evaCoreSPS != null)
		{
			...
			ff9.w_evaCoreSPS.size = ff9.w_evaCoreSPSCurrentSize;
		}
	}

	public static void w_effectRegist(Single x, Single y, Single z, Int32 no, Int32 size)
	{
		ff9.world.WorldSPSSystem.w_effectRegist(x, y, z, no, size);
	}
	...
	public static void w_effectRegist_Event(Int32 x, Int32 y, Int32 z, Int32 no, Int32 size)
	{
		...
		Single z2 = ff9.S(z);
		Vector3 vector;
		ff9.world.SetAbsolutePositionOf(out vector, new Vector3(x2, y2, z2));
		ff9.world.WorldSPSSystem.w_effectRegist(vector.x, vector.y, vector.z, no, size);
	}

	public static void w_effectRegist_FixedPoint(Int32 x, Int32 y, Int32 z, Int32 no, Int32 size)
	{
		Single x2 = ff9.S(x);
		Single y2 = ff9.S(-y);
		Single z2 = ff9.S(z);
	...
	public static WorldSPS w_effectRegist_FixedPoint(Int32 x, Int32 y, Int32 z, Int32 no, Int32 size, Int32 frame)
	{
		Single x2 = ff9.S(x);
		Single y2 = ff9.S(-y);
		Single z2 = ff9.S(z);
		Vector3 vector;
		ff9.world.SetAbsolutePositionOf(out vector, new Vector3(x2, y2, z2));
		Int32 index = ff9.world.WorldSPSSystem.w_effectRegist(vector.x, vector.y, vector.z, no, size);
		WorldSPS worldSPS = ff9.world.WorldSPSSystem.SpsList[index];
		worldSPS.frame = frame;
		return worldSPS;
	}
	...
	public static Int32 w_frameMainRoutine()
	{
		...
		else if (ff9.m_GetIDTopograph(ff9.m_moveActorID) == 52)
		{
			ff9.w_frameResult = 0;
		}
		if (ff9.w_frameInternalSwitchEnable)
	...
	public static void w_frameUpdate()
	{
		...
		if (ff9.UnityUnit(ff9.w_moveActorPtr.pos[0]) != ff9.UnityUnit(ff9.w_moveActorPtr.lastx) || ff9.UnityUnit(ff9.w_moveActorPtr.pos[1]) != ff9.UnityUnit(ff9.w_moveActorPtr.lasty) || ff9.UnityUnit(ff9.w_moveActorPtr.pos[2]) != ff9.UnityUnit(ff9.w_moveActorPtr.lastz))
		{
			ff9.w_moveCHRControl_Move = true;
		}
		else
		{
	...
	public static ff9.Pad w_getPad()
	{
		return ff9.kPad;
	}
	...
	public static void w_movementSystemConstructor()
	{
		...
		for (Int64 num = 0L; num < 11L; num += 1L)
		{
		}
		for (Int64 num = 0L; num < 22L; num += 1L)
		{
			checked
			{
				ff9.w_moveCHRStatus[(Int32)((IntPtr)num)].id = 0;
				ff9.w_moveCHRStatus[(Int32)((IntPtr)num)].slice_height = 0f;
				ff9.w_moveCHRStatus[(Int32)((IntPtr)num)].ground_height = 0f;
			}
		}
		...
		for (ObjList objList = ff9.GetActiveObjList(); objList != null; objList = objList.next)
		{
			...
			if (obj.cid == 4)
			{
				...
				if (ff9.objIsVisible(obj))
				{
					...
					if (ff9.w_moveCHRStatus[posObj.index].slice_height >= ff9.S(-3) && flag)
					{
						ff9.w_FF9DisplayShadow(posObj, ref pos, 0, true);
					}
					else
					{
	...
	public static void w_FF9DisplayShadow(PosObj chr, ref Vector3 pos, Int32 sz, Boolean display)
	{
		...
		if (wmshadow == null)
		{
			...
			{
				Single num = 0.8545044f;
				wmshadow = ff9.world.AddShadow(chr, new Vector3(num, num, num));
			}
			else if (chr.index >= 3 && chr.index <= 7)
			{
				Single num = 1.430598f;
				wmshadow = ff9.world.AddShadow(chr, new Vector3(num, num, num));
			}
		...
		{
			Int32 num2 = ff9.UnityUnit(s_moveCHRStatus.ground_height - ff9.S((Int32)chr.pos[1]));
			pos.y += ff9.S(num2);
			pos.y -= ff9.S(num2) / 8f;
			...
			if (s_moveCHRStatus.cache != 10)
			{
				...
				if (s_moveCHRStatus.flg_fly == 0)
				{
					if (s_moveCHRStatus.slice_type != 0)
					{
						...
						{
							if (s_moveCHRStatus.slice_height < num - ff9.S(21))
							{
								s_moveCHRStatus.slice_height += ff9.S(20);
							}
							if (s_moveCHRStatus.slice_height > num + ff9.S(21))
							{
								s_moveCHRStatus.slice_height -= ff9.S(20);
	...
	public static void w_movementChange()
	{
		...
		ff9.w_moveCHRControl_YAlpha = 0f;
		ff9.w_movementAutoPilotOFF();
		SByte b = ff9.w_moveCHRControl_No;
		if (!FF9StateSystem.World.IsBeeScene)
		{
		...
		if (s_moveCHRControl2.se != 0)
		{
			...
			if (ff9.w_moveCHRControl_No == 8 || ff9.w_moveCHRControl_No == 9)
			{
		...
		if (ff9.w_moveCHRControl_No == 0 && b >= 1 && b <= 6)
		{
			global::Debug.LogWarning("Come visit this later! w_moveCHRControl_RotTrue = (w_moveChocoboPtr.rot[1] + 1024) & 0xfff");
		}
		if (ff9.w_moveCHRControl_No >= 1 && ff9.w_moveCHRControl_No <= 6 && b == 0 && ff9.w_moveChocoboPtr != null)
		{
			ff9.w_moveCHRControl_RotTrue = ff9.w_moveChocoboPtr.rot[1];
		}
		if (ff9.w_moveCHRControl[b].flg_fly == ff9.w_moveCHRControl[ff9.w_moveCHRControl_No].flg_fly)
		{
	...
	private static void w_movementHumanOperation()
	{
		...
		num2 = -num2;
		Single num3 = (-ff9.ratan2(num2, num) + ff9.PsxRot(1024)) % 360f;
		Int32 num4;
		if (num != 0 || num2 != 0)
		{
			num4 = 4096;
		...
		{
			ff9.w_cameraSysDataCamera.rotationMax = ff9.rsin(num5);
			if (num4 != 0)
			{
				ff9.w_moveCHRControl_LR = false;
				if (num5 >= ff9.PsxRot(1536) && num5 <= ff9.PsxRot(2560))
				{
					ff9.w_cameraSysDataCamera.rotationRev = ff9.PsxRot(2048);
				}
				else
				...
				ff9.w_moveCHRControl_XZSpeed = ff9.S(ff9.w_moveCHRControlPtr.speed_move * num4 >> 12);
				ff9.w_moveCHRControl_RotTrue = (ff9.w_cameraSysDataCamera.rotation + num5) % 360f;
			}
		}
		Single num6 = ff9.w_moveCHRControl_RotTrue;
		if (num6 - ff9.w_moveActorPtr.rot1 > ff9.PsxRot(2048))
		{
			num6 -= ff9.PsxRot(4096);
		}
		if (num6 - ff9.w_moveActorPtr.rot1 < ff9.PsxRot(-2048))
		{
			num6 += ff9.PsxRot(4096);
		}
		Single num7 = num6 - ff9.w_moveActorPtr.rot1;
		if (num != 0 || num2 != 0)
		{
			Single num8 = ff9.w_moveActorPtr.rot1;
			num8 += num7 / 3f;
			num8 %= 360f;
			ff9.w_moveActorPtr.rot1 = num8;
		}
	...
	{
		Int32 num;
		ff9.w_moveGetPadStateR(out num);
		Int32 num2;
		ff9.w_moveGetPadStateLX(out num2);
		Int32 num3;
		Boolean flag = ff9.w_moveGetPadStateLY(out num3);
		if (flag)
		{
			num3 = 0;
		}
		...
		{
			ff9.w_moveCHRControl_RotSpeed = ff9.PsxRot((Int32)((Int32)ff9.w_moveCHRControlPtr.speed_rotation * num2 / 256f));
		}
		else
		{
			ff9.w_moveCHRControl_RotSpeed = ff9.PsxRot(ff9.w_moveCHRControlPtr.speed_rotation * num2 >> 7);
		}
		ff9.w_moveCHRControl_LR = false;
		if (ff9.w_getPad().kPadL1)
		{
		...
		ff9.w_moveCHRControl_XZAlpha += (num4 - ff9.w_moveCHRControl_XZAlpha) / ff9.p2;
		ff9.w_moveCHRControl_XZSpeed = ff9.w_moveCHRControl_XZAlpha / ff9.p3;
		Int32 num5 = ff9.abs((Int32)(ff9.w_moveCHRControl_XZSpeed * 256f)) / 8 + 20;
		if (num5 > 127)
		{
			num5 = 127;
		}
		ff9.w_musicSEVolumeIntpl(ff9.w_moveCHRControlPtr.se, 60, (Byte)num5);
		Vector3 rot = ff9.w_moveActorPtr.rot;
		Int32 index2;
		Int32 index = index2 = 1;
		Single num6 = rot[index2];
		rot[index] = num6 + ff9.w_moveCHRControl_RotSpeed;
		Int32 index3 = index2 = 1;
		num6 = rot[index2];
		rot[index3] = num6 % 360f;
		ff9.w_moveCHRControl_RotTrue = rot[1] % 360f;
		ff9.w_moveActorPtr.rot = rot;
	...
	private static void w_movementPlaneOperation()
	{
		...
		{
			rot2[2] = ff9.PsxRot(ff9.w_moveCHRControlPtr.speed_roll * 2);
		}
		if (rot2[2] < ff9.PsxRot(-ff9.w_moveCHRControlPtr.speed_roll * 2))
		{
			rot2[2] = ff9.PsxRot(-ff9.w_moveCHRControlPtr.speed_roll * 2);
	...
	private static void w_movementHumanCamOperation()
	{
		...
		{
			ff9.w_movementCamRemain -= 512f;
			if (ff9.w_movementCamRemain < 0f)
			{
				ff9.w_movementCamRemain = 0f;
			}
		}
	...
	public static void w_naviSystemConstructor()
	{
		...
		if (5990 <= ff9.w_frameScenePtr)
		{
			Int16 num = (Int16)ff9.ushort_gEventGlobal(92);
			num = (Int16)(num | 1984);
			ff9.short_gEventGlobal_Write(92, num);
			num = (Int16)ff9.ushort_gEventGlobal(92);
			if ((num & 49152) != 0)
			{
				num = (Int16)(num | 49152);
				ff9.short_gEventGlobal_Write(92, num);
	...
	public static Int32 w_weatherModeCheck()
	{
		...
		Int32 result = 0;
		Single num = 0.00390625f;
		Single num2 = ff9.w_moveActorPtr.RealPosition[0] * num - ff9.S(329728) * num;
		Single num3 = ff9.w_moveActorPtr.RealPosition[2] * num - ff9.S(-240896) * num;
		...
		if (ff9.w_frameDisc == 4)
		{
			num2 = ff9.w_moveActorPtr.RealPosition[0] * num - ff9.S(196158) * num;
			num3 = ff9.w_moveActorPtr.RealPosition[2] * num - ff9.S(-81825) * num;
	...
	public static Int64 w_weatherModeCheck(Vector3 playerPosition)
	{
		Int64 result = 0L;
		playerPosition.y = 0f;
		Vector3 b = new Vector3(322f, 0f, -236f);
		Single num = Vector3.Distance(playerPosition, b);
		if (num < 21f)
		{
			result = 1L;
		}
		b = new Vector3(322f, 0f, -232f);
		num = Vector3.Distance(playerPosition, b);
		if (num < 14f)
		{
			result = 2L;
		}
		b = new Vector3(125f, 0f, -198f);
		num = Vector3.Distance(playerPosition, b);
		if (num < 45f)
		{
			result = 1L;
	...
	public static void w_worldMapConstructor()
	{
		...
		if (ff9.w_frameScenePtr < 11090 && ff9.w_frameScenePtr >= 6990)
		{
			ff9.w_effectWindMillRot = false;
		}
		else
		{
			ff9.w_effectWindMillRot = true;
		}
	}
	...
	public static void w_worldUpdate()
	{
		...
		if (ff9.w_worldLocDistance[1] < 34 && ff9.GetUserControl() && ff9.m_GetIDTopograph(id) == 23 && index >= 1 && index <= 7)
		{
			...
			Int32 index3;
			Int32 index2 = index3 = 2;
			Single num6 = pos[index3];
			pos[index2] = num6 + ff9.S((34 - ff9.w_worldLocDistance[1]) * 8);
		...
		Vector3 b = new Vector3(30986f, 101f, -23243f);
		Byte b2 = ff9.byte_gEventGlobal(102);
		if (b2 == 8 || b2 == 0)
		{
			Vector3 a = ff9.w_moveActorPtr.RealPosition;
			a *= 32f;
			Int32 num3 = Mathf.FloorToInt((a - b).magnitude);
			if (num3 < 1148)
			{
				Int32 num7 = 1148 - num3;
				Int32 speed = 64;
				if (num7 > 1024)
				{
					num7 = 1024;
				...
				{
					num7 >>= 4;
					ff9.rainRenderer.SetRainParam(num7, speed);
					ff9.w_frameRain = true;
					FF9StateSystem.Common.FF9.btl_rain = (Byte)(num7 >> 4);
				}
				else
				{
					ff9.w_frameRain = false;
	...
	public static readonly ff9.Pad kPad = new ff9.Pad();
	...
	public static readonly ff9.s_moveCHRControl[] w_moveCHRControl;

	public static readonly ff9.s_moveCHRStatus[] w_moveCHRStatus;
	...
	public static WorldSPS w_evaCoreSPS;
	...
	public static Boolean w_effectWindMillRot;
	...
	public static readonly Byte[] w_worldFormFlag;

	public static readonly Byte[,] w_worldFormData;

	public static readonly UInt16[] w_worldFormDataTyming;
	...
	public class Pad
	{
		...
		public Boolean kPadL1
		{
			get
			{
				return UIManager.Input.GetKey(Control.LeftBumper);
			}
		}

		public Boolean kPadL2
		{
			get
			{
		...
		public Boolean kPadR1
		{
			get
			{
				return UIManager.Input.GetKey(Control.RightBumper);
			}
		}

		public Boolean kPadR2
		{
			get
			{
		...
		public Boolean kPadSelect
		{
			get
			{
				return UIManager.Input.GetKey(Control.Select);
			}
		}

		public Boolean kPadStart
		{
			get
			{
				return UIManager.Input.GetKey(Control.Pause);
			}
		}
	}

	public class s_moveCHRControl
	{
		public Byte type;
	...
	public struct sw_weatherColorElement
	{
		public ff9.SVECTOR light0;

		public ff9.SVECTOR light1;

		public ff9.SVECTOR light2;

		public ff9.SVECTOR light0c;

		public ff9.SVECTOR ambient;

		public ff9.SVECTOR ambientcl;

		public UInt16 goffsetup;

		public UInt16 toffsetup;

		public ff9.SVECTOR fogUP;

		public UInt16 goffsetdw;

		public UInt16 toffsetdw;

		public ff9.SVECTOR fogDW;

		public UInt16 goffsetcl;

		public UInt16 toffsetcl;

		public ff9.SVECTOR fogCL;

		public ff9.SVECTOR chrBIAS;
	...
	public class sw_weatherColor
	{
		public sw_weatherColor()
		{
			...
			{
				this.Color[i] = default(ff9.sw_weatherColorElement);
			}
